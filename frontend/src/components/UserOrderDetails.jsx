    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
          ...
          <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-3">
            ...
            <div className="w-full flex">
              ...
              <div>
                ...
                <h4 className="pl-3 text-[20px]">
                  {selectedItem?.price +"VNĐ"} x {selectedItem?.qty}
                </h4>
              </div>
            </div>
            ...
            <div className="w-full ml-3">
              ...
              <textarea
                ...
                placeholder="Hãy viết cảm nghỉ và đánh giá của bạn sau khi mua hàng ở đây !"
      ...
      <div className="border-t w-full text-right">
        <h5 className="pt-3 text-[18px]">
            Tổng giá: <strong>{data?.totalPrice}
      ...
      <div className="w-full 800px:flex items-center">
        <div className="w-full 800px:w-[60%]">
          ...
          <div className="pt-3 text-[20px] flex items-center">
              <h4 className=" text-[20px] 800px:text-[unset]">
