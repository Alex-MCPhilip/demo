...
const AdminEvents = () => {
 ...
 const minEndDate = startDate ? new Date(startDate.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString().slice(0,10) : "";
  ...
  const handleSubmit = (e) => {
    ...
    newForm.append("price", discountPrice);
    newForm.append("stock", stock);
    newForm.append("start_Date", startDate.toISOString());
    newForm.append("Finish_Date", endDate.toISOString());
    newForm.append("createdBy", user._id);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Hãy điền tến của sản phẩm..."
          />
        </div>
        <br />
        <div>
          ...
          <textarea
            ...
            placeholder="Hãy điền miêu tả của sản phẩm..."
          ></textarea>
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Hãy điền thẻ tags của sản phẩm..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Hãy điền giá lúc đầu..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Hãy điền giá khi giảm..."
          />
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <input
            ...
            min={today}
            placeholder="Hãy điền ngày bắt đầu sự kiện..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            min={minEndDate}
            placeholder="Hãy điền ngày kết thúc sự kiện..."
          />
        </div>
        <br />
