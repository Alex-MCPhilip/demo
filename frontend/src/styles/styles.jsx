const styles = {
    ...
    productDiscountPrice:"font-bold text-[18px] text-[#00ab9f] font-Roboto",
    price:"font-[500] text-[16px] text-[#ababab] mt-[-4px] line-through",
    shop_name:"pt-3 text-[15px] text-blue-400 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'w-[150px] bg-[#00ab9f] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
